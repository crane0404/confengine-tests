...
public class ProductListPageScreenWeb extends ProductListPageScreen {
    ...
    private static final By productTupleTitle= By.xpath("//div[@data-index='2']//span[@class='a-size-medium a-color-base a-text-normal']");
    private static final By productTuplePrice= By.xpath("//div[@data-index='2']//span[@class='a-price-whole']");
    ...
    public String getFirstProductTitle(){
        ...
        return driver.findElement(productTupleTitle).getText().trim();
    }
    ...
    public ProductLandingPageScreen userSelectsFirstProduct() {
        ...
        driver.waitTillElementIsPresent(productTupleTitle);
